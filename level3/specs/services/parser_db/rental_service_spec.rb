...
RSpec.describe ParserDb::RentalService do
  ...
  describe "#call" do
    ...
    it "call equal at {:id=>1, :price=>6600, :commission=>{:insurance_fee=>990, :assistance_fee=>300, :drivy_fee=>690}}" do
      expect(subject.call).to eq({:id=>1, :price=>6600, :commission=>{:insurance_fee=>990, :assistance_fee=>300, :drivy_fee=>690}})
     end
  end

  describe "#count_rental" do
    it "#count_rentali at {:id=>1, :price=>6600, :commission=>{:insurance_fee=>990, :assistance_fee=>300, :drivy_fee=>690}}" do
      expect(subject.count_rental).to eq({:id=>1, :price=>6600, :commission=>{:insurance_fee=>990, :assistance_fee=>300, :drivy_fee=>690}})
    end
  end

  describe "#Private method" do
    describe "#get_price" do
      let(:get_price) {subject.send(:get_price)}
      it "get_Price" do
        expect(get_price).to eq(1000)
      end
    end
